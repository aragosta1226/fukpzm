...
<head>
  ...
  wedding,weddinparty,結婚式２次会,企業パーティー,ビーチパーティー,文化祭,モーターショー,
...
<body>
  ...
  ------------------------------------------------------------------------------>
  <header id="header">
    <img class="logo_img" src="./img/headerlogo.png" alt="">
    <nav>
      <ul id="g-navi">
  ...
  <div class="mainvisual">
    <img src="./img/main.png" width="100%" height="100%" alt="福岡のパーティー絶対盛り上げる">
  </div>
  <!-----------------------------------------------------------------------------
    * ABOUT
  ------------------------------------------------------------------------------>
  ...
  <div>
    <div>
      <p>point 1</p>
      <h2>パーティーに詳しい現役DJが担当</h2>
      <p>さまざまなシーンで実績を積んできたプロのDJがパーティーでDJするので安心して<br>
        開催する事ができます。どんなパーティーにしたいかをしっかりとお打ち合わせ頂きまして、<br>
        お客様の為に熟練のDJがイチから選曲リストを作成し、当日皆様がハッピーになっていただける様にします。</p>
    </div>
    <div>
      <p>point 2</p>
      <h2>今まで目に見えなかった進捗状況の確認ができる</h2>
      <p>今まで準備の進み具合が確認できなくて不安だったと思います。弊社はそんな進捗状況をちゃんと確認<br>
        する事が出来ます。パーティー当日までの、「今どんな状況になっているのかな？」という不安を解消します。<br>
        主催される方の気持ちに寄り添います。</p>
    </div>
  </div>
  <a href="#form">お問い合わせはこちら</a>
  ...
  <div>
    <div>
      <p>Step 1</p>
      <h2>お問い合わせ</h2>
      <p>実際にどんな事が出来るのか知りたいと思います。<br>
        不安な事など、一緒に解決していければと考えています。<br>
        まずはお気軽にお問い合わせください。</p>
    </div>
    <div>
      <p>Step 2</p>
      <h2>ヒアリング</h2>
      <p>お問い合わせ頂きましたら、弊社よりメールにて<br>
        日程を決めさせて頂き、担当者のみカメラオンにてZOOM等で<br>
        お打ち合わせさせて頂きます。相談料などは頂きませんので、<br>
        お気軽にお話ししましょう！。</p>
    </div>
    <div>
      <p>Step 3</p>
      <h2>準備の進捗状況の確認</h2>
      <p>パーティーの内容や金額に関して、気に入ってい頂きましたら、<br>
        再度内容の確認等を行っていただければさっそく準備に入ります。<br>
        準備の進捗状況に関して、丁寧に対応させて頂きます。</p>
    </div>
    <div>
      <p>Step 4</p>
      <h2>イベント当日</h2>
      <p>イベント当日は、現場の確認等させて頂きますのでパーティー開始の<br>
        1時間程度前から現場入りさせて頂きますのでご安心ください。</p>
    </div>
  </div>
  <a href="#form">お問い合わせはこちら</a>
  ...
  <!-- <div>
    ...
    <div>
      <h2><strong>電源がないところで開催したいのですが、可能ですか？</strong></h2>
